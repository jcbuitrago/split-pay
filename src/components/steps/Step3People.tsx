  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4">
        <h2 className="text-lg font-bold text-gray-900">¿Quiénes pagan?</h2>
        <p className="text-sm text-gray-500 -mt-2">Agrega al menos 2 personas para continuar.</p>
        ...
        {state.people.length === 0 && (
          <p className="text-gray-400 text-sm text-center py-6">Sin personas aún.</p>
        )}
