...
import { calculateSubtotal, calculateTax, calculateTip } from '../../utils/calculations';
  ...
  return (
    <div className="flex flex-col flex-1">
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-5">
        <h2 className="text-lg font-bold text-gray-900">Impuesto y propina</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xs text-gray-500">IVA típico en restaurantes Colombia: 8%</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <span className="font-semibold text-gray-900">Propina</span>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            />
            <label htmlFor="tipVoluntary" className="text-sm text-gray-600 cursor-pointer">
              Propina voluntaria
            </label>
          </div>
          {state.tipIsVoluntary && (
            <p className="text-xs text-gray-400">(La propina es voluntaria — Ley colombiana)</p>
          )}
        </div>
